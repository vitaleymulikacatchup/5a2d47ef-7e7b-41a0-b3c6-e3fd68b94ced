...
export const metadata: Metadata = {
  title: 'Hotel Haven - Luxury & Comfort',
  description: 'Discover luxury and comfort at Hotel Haven, located in the heart of the city.',
  openGraph: {
    title: 'Hotel Haven - Luxury & Comfort',
    description: 'Discover luxury and comfort at Hotel Haven.',
    url: 'https://hotelhaven.com',
    siteName: 'Hotel Haven',
    images: [
      {
  ...
  return (
    <html lang='en'>
      <PostHogWrapper>
        <body
          className={
            `${interTight.variable} ${playfairDisplay.variable} ${roboto.variable} ${openSans.variable} ${lato.variable} ${montserrat.variable} ${poppins.variable} ${raleway.variable} ${ubuntu.variable} ${nunito.variable} antialiased`
          }
        >
          <AuroraBackground />
          {children}
